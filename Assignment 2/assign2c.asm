...
// Version c: Use 32-bit registers for variables delcared using int. Use m4 macros to name the registers to make your code more readable. 
...
//            *** For version C, x is initialized with 0x01FF01FF ***
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
main:       stp x29, x30, [sp, -16]!                                                    // Store X29 and X30 at the address pointed to by SP. [SP, -16]! decreases SP by 16 *BEFORE* this operation is done.
            ...
            mov x_r, 0x01FF01FF                                                         // Initialize x with 0x01FF01FF
